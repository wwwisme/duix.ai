...
<div style="display: flex;justify-content: center;gap: 1px;flex-wrap: wrap;">
  <a href="https://duix.com/"><img src="res/duix_home.png" alt="图片1" style="width: 157px;height: 28px;margin-right: 30px;text-decoration: none;"></a>
  <a href="https://docs.duix.com/api-reference/api/Introduction"><img src="res/duix_doc.png" alt="图片2" style="width: 157px;height: 28px;"margin-right: 30px;text-decoration: none;></a>
  <a href="https://duix.com/platform/create"><img src="res/duix_conversation.png" alt="图片3" style="width: 242px;height: 28px;"margin-right: 30px;text-decoration: none;></a>
  <a href="https://duix.com/platform/replicas"><img src="res/duix_more.png" alt="图片4" style="width: 200px;height: 28px;margin-right: 30px;text-decoration: none;"></a>
</div>
